...
const Dashboard = () => {
  return <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <StatCard title="At-Risk Individuals" value="250" change="Updated today" isPositive={false} icon={<AlertCircleIcon size={24} className="text-orange-600" />} />
        <StatCard title="High Risk Cases" value="50" change="Requires immediate attention" isPositive={false} icon={<AlertCircleIcon size={24} className="text-red-600" />} />
